...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', default='/home/pil/data/ocr/svt1', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--mask_type', type=str, default='center', help='the type of mask you want to apply, [center|random|text-char|text-txt_bb]')
        ...
        parser.add_argument('--skip', type=int, default=1, help='Define whether the guidance layer is skipped. It is a workaround when using multiGPUs.')
